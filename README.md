...
- https://unofficialaciguide.com/2018/11/29/best-practices-for-curling/
...
- Optional: edit the CURL_OPTS to match your environment. Defaults include -s (suppress status), and -k (accept insecure/self-signed certificates).
